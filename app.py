...
with tab_consolidado:
    ...
    # Cálculo do Saldo Acumulado da Caixinha
    ...
    # Lógica de Extração e Rollover (Saldo Acumulado Mês a Mês)
    def calcular_projecao_completa():
        dados_meses = {}
        saldo_anterior = 0.0  # Início zerado no primeiro mês
        ...
        for mes in MESES_PROJECAO:
            ...
            # O saldo final deste mês vira o saldo inicial do próximo
    ...
    with c4:
        ...
        # Alerta visual de sobra/déficit
    ...
    # Simulador de Divisão Proporcional das Contas da Casa
    ...
    with g_col1:
        # Gráfico de Rosca - Distribuição de Gastos do Mês
    ...
    with g_col2:
        # Gráfico de Curva de Crescimento da Caixinha
    ...
    # Gráfico de Barras - Renda vs Despesa Mês a Mês
    list_barras = []
    ...
    # Tabela de Projeção Evolutiva Completa
