...
def get_fixos_mes(pessoa, mes_banco):
    ...
    # Se não houver dados salvos explicitamente para este mês, busca o mês anterior para sugestão inicial
    try:
...
# ====================================================================
    ...
    def renderizar_pessoa(pessoa, p_code):
        ...
        st.caption("ℹ️ Editando os gastos fixos específicos para o mês selecionado. (Ao salvar a primeira vez neste mês, ele passa a ser independente).")
